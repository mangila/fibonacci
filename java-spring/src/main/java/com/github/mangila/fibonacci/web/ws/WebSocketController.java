...
public class WebSocketController {
    ...
    public List<FibonacciProjectionDto> queueFibonacciSequences(@Valid @NotNull FibonacciQuery query, Principal principal) {
    ...
    public FibonacciDto queryById(@Min(1) int id, Principal principal) {
